...
class SpatialAttack:
    ...
    def perturb_grid(self, x_nat, y, max_func, sess, random_tries=-1):
        ...
        if random_tries > 0:
            ...
            grid = [(42, 42, 42, 42, 42, 42, 42, 42) for _ in range(random_tries)] # dummy list
        ...
        for tx, ty, r, r1,r2,r3,r4,r5 in grid:
            if random_tries > 0:
                ...
                t = np.stack(repeat([tx, ty, r, r1,r2,r3,r4,r5], n))
